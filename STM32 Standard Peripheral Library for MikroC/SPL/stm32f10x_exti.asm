stm32f10x_exti_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f10x_exti_NVIC_SetPriorityGrouping
stm32f10x_exti_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f10x_exti_NVIC_GetPriorityGrouping
stm32f10x_exti_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f10x_exti_NVIC_EnableIRQ
stm32f10x_exti_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f10x_exti_NVIC_DisableIRQ
stm32f10x_exti_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_exti_NVIC_GetPendingIRQ0
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_exti_NVIC_GetPendingIRQ1
L_stm32f10x_exti_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
L_stm32f10x_exti_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_exti_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_exti_NVIC_GetPendingIRQ
stm32f10x_exti_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f10x_exti_NVIC_SetPendingIRQ
stm32f10x_exti_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f10x_exti_NVIC_ClearPendingIRQ
stm32f10x_exti_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_exti_NVIC_GetActive2
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_exti_NVIC_GetActive3
L_stm32f10x_exti_NVIC_GetActive2:
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 end address is: 0 (R0)
L_stm32f10x_exti_NVIC_GetActive3:
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_exti_NVIC_GetActive?T72 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_exti_NVIC_GetActive
stm32f10x_exti_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_exti_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f10x_exti_NVIC_SetPriority5
L_stm32f10x_exti_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f10x_exti_NVIC_SetPriority5:
;core_cm3.h,1653 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f10x_exti_NVIC_SetPriority
stm32f10x_exti_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_exti_NVIC_GetPriority6
...
L_stm32f10x_exti_NVIC_GetPriority6:
...
BX	LR
; end of stm32f10x_exti_NVIC_GetPriority
stm32f10x_exti_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f10x_exti_NVIC_EncodePriority8
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T112 start address is: 12 (R3)
MOVW	R3, #4
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T112 end address is: 12 (R3)
IT	AL
BAL	L_stm32f10x_exti_NVIC_EncodePriority9
L_stm32f10x_exti_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T112 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T112 end address is: 0 (R0)
MOV	R3, R0
L_stm32f10x_exti_NVIC_EncodePriority9:
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T112 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f10x_exti_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T116 start address is: 20 (R5)
MOVW	R5, #0
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T116 end address is: 20 (R5)
IT	AL
BAL	L_stm32f10x_exti_NVIC_EncodePriority11
L_stm32f10x_exti_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T116 start address is: 20 (R5)
; ?FLOC__stm32f10x_exti_NVIC_EncodePriority?T116 end address is: 20 (R5)
L_stm32f10x_exti_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f10x_exti_NVIC_EncodePriority
stm32f10x_exti_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f10x_exti_NVIC_DecodePriority12
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T130 start address is: 16 (R4)
MOVW	R4, #4
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T130 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_exti_NVIC_DecodePriority13
L_stm32f10x_exti_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T130 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T130 end address is: 4 (R1)
MOV	R4, R1
L_stm32f10x_exti_NVIC_DecodePriority13:
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T130 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f10x_exti_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T134 start address is: 16 (R4)
MOVW	R4, #0
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T134 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_exti_NVIC_DecodePriority15
L_stm32f10x_exti_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T134 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T134 end address is: 20 (R5)
MOV	R4, R5
L_stm32f10x_exti_NVIC_DecodePriority15:
; ?FLOC__stm32f10x_exti_NVIC_DecodePriority?T134 start address is: 16 (R4)
...
BX	LR
; end of stm32f10x_exti_NVIC_DecodePriority
stm32f10x_exti_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f10x_exti_SysTick_Config16
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f10x_exti_SysTick_Config16:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f10x_exti_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_exti_SysTick_Config
stm32f10x_exti_NVIC_SystemReset:
...
L_stm32f10x_exti_NVIC_SystemReset17:
IT	AL
BAL	L_stm32f10x_exti_NVIC_SystemReset17
;core_cm3.h,1787 :: 		}
L_end_NVIC_SystemReset:
BX	LR
; end of stm32f10x_exti_NVIC_SystemReset
stm32f10x_exti_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_exti_ITM_SendChar41
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_exti_ITM_SendChar42
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_exti_ITM_SendChar43
L_stm32f10x_exti_ITM_SendChar37:
;core_cm3.h,1823 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f10x_exti_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f10x_exti_ITM_SendChar23
IT	AL
BAL	L_stm32f10x_exti_ITM_SendChar22
L_stm32f10x_exti_ITM_SendChar23:
...
;core_cm3.h,1820 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f10x_exti_ITM_SendChar40
L_stm32f10x_exti_ITM_SendChar41:
L_stm32f10x_exti_ITM_SendChar40:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_exti_ITM_SendChar39
L_stm32f10x_exti_ITM_SendChar42:
L_stm32f10x_exti_ITM_SendChar39:
;core_cm3.h,1821 :: 		(ITM->TER & (1ul << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_exti_ITM_SendChar38
L_stm32f10x_exti_ITM_SendChar43:
L_stm32f10x_exti_ITM_SendChar38:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f10x_exti_ITM_SendChar
stm32f10x_exti_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f10x_exti_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm3.h,1845 :: 		}
L_stm32f10x_exti_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_exti_ITM_ReceiveChar
stm32f10x_exti_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f10x_exti_ITM_CheckChar25
;core_cm3.h,1862 :: 		return (0);                                 /* no character available */
MOVW	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm3.h,1863 :: 		} else {
L_stm32f10x_exti_ITM_CheckChar25:
;core_cm3.h,1864 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm3.h,1866 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f10x_exti_ITM_CheckChar
_EXTI_DeInit:
;stm32f10x_exti.c,85 :: 		void EXTI_DeInit(void)
;stm32f10x_exti.c,87 :: 		EXTI->IMR = 0x00000000;
MOVW	R1, #0
MOVW	R0, #1024
MOVT	R0, #16385
STR	R1, [R0, #0]
;stm32f10x_exti.c,88 :: 		EXTI->EMR = 0x00000000;
MOVW	R1, #0
MOVW	R0, #1028
MOVT	R0, #16385
STR	R1, [R0, #0]
;stm32f10x_exti.c,89 :: 		EXTI->RTSR = 0x00000000;
MOVW	R1, #0
MOVW	R0, #1032
MOVT	R0, #16385
STR	R1, [R0, #0]
;stm32f10x_exti.c,90 :: 		EXTI->FTSR = 0x00000000;
MOVW	R1, #0
MOVW	R0, #1036
MOVT	R0, #16385
STR	R1, [R0, #0]
;stm32f10x_exti.c,91 :: 		EXTI->PR = 0x000FFFFF;
MOVW	R1, #65535
MOVT	R1, #15
MOVW	R0, #1044
MOVT	R0, #16385
...
; end of _EXTI_DeInit
_EXTI_Init:
;stm32f10x_exti.c,101 :: 		void EXTI_Init(EXTI_InitTypeDef* EXTI_InitStruct)
; EXTI_InitStruct start address is: 0 (R0)
; EXTI_InitStruct end address is: 0 (R0)
; EXTI_InitStruct start address is: 0 (R0)
;stm32f10x_exti.c,103 :: 		uint32_t tmp = 0;
;stm32f10x_exti.c,111 :: 		tmp = (uint32_t)EXTI_BASE;
; tmp start address is: 16 (R4)
MOVW	R4, #1024
MOVT	R4, #16385
;stm32f10x_exti.c,113 :: 		if (EXTI_InitStruct->EXTI_LineCmd != DISABLE)
ADDS	R1, R0, #6
LDRB	R1, [R1, #0]
CMP	R1, #0
IT	EQ
BEQ	L_EXTI_Init27
;stm32f10x_exti.c,116 :: 		EXTI->IMR &= ~EXTI_InitStruct->EXTI_Line;
LDR	R1, [R0, #0]
MVN	R3, R1
MOVW	R2, #1024
MOVT	R2, #16385
...
ANDS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,117 :: 		EXTI->EMR &= ~EXTI_InitStruct->EXTI_Line;
LDR	R1, [R0, #0]
MVN	R3, R1
MOVW	R2, #1028
MOVT	R2, #16385
...
ANDS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,119 :: 		tmp += EXTI_InitStruct->EXTI_Mode;
ADDS	R1, R0, #4
LDRB	R1, [R1, #0]
ADDS	R3, R4, R1
; tmp end address is: 16 (R4)
;stm32f10x_exti.c,121 :: 		*(__IO uint32_t *) tmp |= EXTI_InitStruct->EXTI_Line;
LDR	R2, [R0, #0]
LDR	R1, [R3, #0]
ORRS	R1, R2
STR	R1, [R3, #0]
;stm32f10x_exti.c,124 :: 		EXTI->RTSR &= ~EXTI_InitStruct->EXTI_Line;
LDR	R1, [R0, #0]
MVN	R3, R1
MOVW	R2, #1032
MOVT	R2, #16385
...
ANDS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,125 :: 		EXTI->FTSR &= ~EXTI_InitStruct->EXTI_Line;
LDR	R1, [R0, #0]
MVN	R3, R1
MOVW	R2, #1036
MOVT	R2, #16385
...
ANDS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,128 :: 		if (EXTI_InitStruct->EXTI_Trigger == EXTI_Trigger_Rising_Falling)
ADDS	R1, R0, #5
LDRB	R1, [R1, #0]
CMP	R1, #16
IT	NE
BNE	L_EXTI_Init28
;stm32f10x_exti.c,131 :: 		EXTI->RTSR |= EXTI_InitStruct->EXTI_Line;
LDR	R3, [R0, #0]
MOVW	R2, #1032
MOVT	R2, #16385
LDR	R1, [R2, #0]
ORRS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,132 :: 		EXTI->FTSR |= EXTI_InitStruct->EXTI_Line;
LDR	R3, [R0, #0]
; EXTI_InitStruct end address is: 0 (R0)
MOVW	R2, #1036
MOVT	R2, #16385
...
ORRS	R1, R3
STR	R1, [R2, #0]
;stm32f10x_exti.c,133 :: 		}
IT	AL
BAL	L_EXTI_Init29
L_EXTI_Init28:
;stm32f10x_exti.c,137 :: 		tmp += EXTI_InitStruct->EXTI_Trigger;
; EXTI_InitStruct start address is: 0 (R0)
ADDS	R1, R0, #5
LDRB	R2, [R1, #0]
MOVW	R1, #1024
MOVT	R1, #16385
ADDS	R3, R1, R2
;stm32f10x_exti.c,139 :: 		*(__IO uint32_t *) tmp |= EXTI_InitStruct->EXTI_Line;
LDR	R2, [R0, #0]
; EXTI_InitStruct end address is: 0 (R0)
LDR	R1, [R3, #0]
ORRS	R1, R2
STR	R1, [R3, #0]
;stm32f10x_exti.c,140 :: 		}
L_EXTI_Init29:
;stm32f10x_exti.c,141 :: 		}
IT	AL
BAL	L_EXTI_Init30
L_EXTI_Init27:
;stm32f10x_exti.c,144 :: 		tmp += EXTI_InitStruct->EXTI_Mode;
; tmp start address is: 16 (R4)
; EXTI_InitStruct start address is: 0 (R0)
ADDS	R1, R0, #4
LDRB	R1, [R1, #0]
ADDS	R3, R4, R1
; tmp end address is: 16 (R4)
;stm32f10x_exti.c,147 :: 		*(__IO uint32_t *) tmp &= ~EXTI_InitStruct->EXTI_Line;
LDR	R1, [R0, #0]
; EXTI_InitStruct end address is: 0 (R0)
MVN	R2, R1
LDR	R1, [R3, #0]
ANDS	R1, R2
STR	R1, [R3, #0]
;stm32f10x_exti.c,148 :: 		}
L_EXTI_Init30:
;stm32f10x_exti.c,149 :: 		}
L_end_EXTI_Init:
BX	LR
; end of _EXTI_Init
_EXTI_StructInit:
;stm32f10x_exti.c,157 :: 		void EXTI_StructInit(EXTI_InitTypeDef* EXTI_InitStruct)
; EXTI_InitStruct start address is: 0 (R0)
; EXTI_InitStruct end address is: 0 (R0)
; EXTI_InitStruct start address is: 0 (R0)
;stm32f10x_exti.c,159 :: 		EXTI_InitStruct->EXTI_Line = EXTI_LINENONE;
MOV	R1, #0
STR	R1, [R0, #0]
;stm32f10x_exti.c,160 :: 		EXTI_InitStruct->EXTI_Mode = EXTI_Mode_Interrupt;
ADDS	R2, R0, #4
MOVS	R1, #0
STRB	R1, [R2, #0]
;stm32f10x_exti.c,161 :: 		EXTI_InitStruct->EXTI_Trigger = EXTI_Trigger_Falling;
ADDS	R2, R0, #5
MOVS	R1, #12
STRB	R1, [R2, #0]
;stm32f10x_exti.c,162 :: 		EXTI_InitStruct->EXTI_LineCmd = DISABLE;
ADDS	R2, R0, #6
; EXTI_InitStruct end address is: 0 (R0)
MOVS	R1, #0
STRB	R1, [R2, #0]
;stm32f10x_exti.c,163 :: 		}
L_end_EXTI_StructInit:
BX	LR
; end of _EXTI_StructInit
_EXTI_GenerateSWInterrupt:
;stm32f10x_exti.c,171 :: 		void EXTI_GenerateSWInterrupt(uint32_t EXTI_Line)
; EXTI_Line start address is: 0 (R0)
; EXTI_Line end address is: 0 (R0)
; EXTI_Line start address is: 0 (R0)
;stm32f10x_exti.c,176 :: 		EXTI->SWIER |= EXTI_Line;
MOVW	R2, #1040
MOVT	R2, #16385
LDR	R1, [R2, #0]
ORRS	R1, R0
; EXTI_Line end address is: 0 (R0)
STR	R1, [R2, #0]
;stm32f10x_exti.c,177 :: 		}
L_end_EXTI_GenerateSWInterrupt:
BX	LR
; end of _EXTI_GenerateSWInterrupt
_EXTI_GetFlagStatus:
;stm32f10x_exti.c,186 :: 		FlagStatus EXTI_GetFlagStatus(uint32_t EXTI_Line)
; EXTI_Line start address is: 0 (R0)
; EXTI_Line end address is: 0 (R0)
; EXTI_Line start address is: 0 (R0)
;stm32f10x_exti.c,188 :: 		FlagStatus bitstatus = RESET;
;stm32f10x_exti.c,192 :: 		if ((EXTI->PR & EXTI_Line) != (uint32_t)RESET)
MOVW	R1, #1044
MOVT	R1, #16385
LDR	R1, [R1, #0]
ANDS	R1, R0
...
;stm32f10x_exti.c,194 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f10x_exti.c,195 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
BAL	L_EXTI_GetFlagStatus32
L_EXTI_GetFlagStatus31:
;stm32f10x_exti.c,198 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f10x_exti.c,199 :: 		}
L_EXTI_GetFlagStatus32:
;stm32f10x_exti.c,200 :: 		return bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f10x_exti.c,201 :: 		}
L_end_EXTI_GetFlagStatus:
BX	LR
; end of _EXTI_GetFlagStatus
_EXTI_ClearFlag:
;stm32f10x_exti.c,209 :: 		void EXTI_ClearFlag(uint32_t EXTI_Line)
; EXTI_Line start address is: 0 (R0)
; EXTI_Line end address is: 0 (R0)
; EXTI_Line start address is: 0 (R0)
;stm32f10x_exti.c,214 :: 		EXTI->PR = EXTI_Line;
MOVW	R1, #1044
MOVT	R1, #16385
STR	R0, [R1, #0]
; EXTI_Line end address is: 0 (R0)
;stm32f10x_exti.c,215 :: 		}
L_end_EXTI_ClearFlag:
BX	LR
; end of _EXTI_ClearFlag
_EXTI_GetITStatus:
;stm32f10x_exti.c,224 :: 		ITStatus EXTI_GetITStatus(uint32_t EXTI_Line)
; EXTI_Line start address is: 0 (R0)
; EXTI_Line end address is: 0 (R0)
; EXTI_Line start address is: 0 (R0)
;stm32f10x_exti.c,226 :: 		ITStatus bitstatus = RESET;
;stm32f10x_exti.c,227 :: 		uint32_t enablestatus = 0;
;stm32f10x_exti.c,231 :: 		enablestatus =  EXTI->IMR & EXTI_Line;
MOVW	R1, #1024
MOVT	R1, #16385
LDR	R1, [R1, #0]
ANDS	R1, R0
...
MOV	R2, R1
;stm32f10x_exti.c,232 :: 		if (((EXTI->PR & EXTI_Line) != (uint32_t)RESET) && (enablestatus != (uint32_t)RESET))
MOVW	R1, #1044
MOVT	R1, #16385
LDR	R1, [R1, #0]
ANDS	R1, R0
...
;stm32f10x_exti.c,234 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f10x_exti.c,235 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
...
;stm32f10x_exti.c,238 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f10x_exti.c,239 :: 		}
L_EXTI_GetITStatus36:
;stm32f10x_exti.c,240 :: 		return bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f10x_exti.c,241 :: 		}
L_end_EXTI_GetITStatus:
BX	LR
; end of _EXTI_GetITStatus
_EXTI_ClearITPendingBit:
;stm32f10x_exti.c,249 :: 		void EXTI_ClearITPendingBit(uint32_t EXTI_Line)
; EXTI_Line start address is: 0 (R0)
; EXTI_Line end address is: 0 (R0)
; EXTI_Line start address is: 0 (R0)
;stm32f10x_exti.c,254 :: 		EXTI->PR = EXTI_Line;
MOVW	R1, #1044
MOVT	R1, #16385
STR	R0, [R1, #0]
; EXTI_Line end address is: 0 (R0)
;stm32f10x_exti.c,255 :: 		}
