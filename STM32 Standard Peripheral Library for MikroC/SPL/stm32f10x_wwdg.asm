stm32f10x_wwdg_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_SetPriorityGrouping
stm32f10x_wwdg_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_GetPriorityGrouping
stm32f10x_wwdg_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_EnableIRQ
stm32f10x_wwdg_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_DisableIRQ
stm32f10x_wwdg_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_wwdg_NVIC_GetPendingIRQ0
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_GetPendingIRQ1
L_stm32f10x_wwdg_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
L_stm32f10x_wwdg_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_wwdg_NVIC_GetPendingIRQ
stm32f10x_wwdg_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_SetPendingIRQ
stm32f10x_wwdg_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_ClearPendingIRQ
stm32f10x_wwdg_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_wwdg_NVIC_GetActive2
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_GetActive3
L_stm32f10x_wwdg_NVIC_GetActive2:
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 end address is: 0 (R0)
L_stm32f10x_wwdg_NVIC_GetActive3:
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_wwdg_NVIC_GetActive?T72 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_wwdg_NVIC_GetActive
stm32f10x_wwdg_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_wwdg_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_SetPriority5
L_stm32f10x_wwdg_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f10x_wwdg_NVIC_SetPriority5:
;core_cm3.h,1653 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f10x_wwdg_NVIC_SetPriority
stm32f10x_wwdg_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_wwdg_NVIC_GetPriority6
...
L_stm32f10x_wwdg_NVIC_GetPriority6:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_GetPriority
stm32f10x_wwdg_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f10x_wwdg_NVIC_EncodePriority8
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T112 start address is: 12 (R3)
MOVW	R3, #4
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T112 end address is: 12 (R3)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_EncodePriority9
L_stm32f10x_wwdg_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T112 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T112 end address is: 0 (R0)
MOV	R3, R0
L_stm32f10x_wwdg_NVIC_EncodePriority9:
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T112 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f10x_wwdg_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T116 start address is: 20 (R5)
MOVW	R5, #0
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T116 end address is: 20 (R5)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_EncodePriority11
L_stm32f10x_wwdg_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T116 start address is: 20 (R5)
; ?FLOC__stm32f10x_wwdg_NVIC_EncodePriority?T116 end address is: 20 (R5)
L_stm32f10x_wwdg_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f10x_wwdg_NVIC_EncodePriority
stm32f10x_wwdg_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f10x_wwdg_NVIC_DecodePriority12
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T130 start address is: 16 (R4)
MOVW	R4, #4
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T130 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_DecodePriority13
L_stm32f10x_wwdg_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T130 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T130 end address is: 4 (R1)
MOV	R4, R1
L_stm32f10x_wwdg_NVIC_DecodePriority13:
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T130 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f10x_wwdg_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T134 start address is: 16 (R4)
MOVW	R4, #0
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T134 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_DecodePriority15
L_stm32f10x_wwdg_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T134 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T134 end address is: 20 (R5)
MOV	R4, R5
L_stm32f10x_wwdg_NVIC_DecodePriority15:
; ?FLOC__stm32f10x_wwdg_NVIC_DecodePriority?T134 start address is: 16 (R4)
...
BX	LR
; end of stm32f10x_wwdg_NVIC_DecodePriority
stm32f10x_wwdg_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f10x_wwdg_SysTick_Config16
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f10x_wwdg_SysTick_Config16:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f10x_wwdg_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_wwdg_SysTick_Config
stm32f10x_wwdg_NVIC_SystemReset:
...
L_stm32f10x_wwdg_NVIC_SystemReset17:
IT	AL
BAL	L_stm32f10x_wwdg_NVIC_SystemReset17
;core_cm3.h,1787 :: 		}
L_end_NVIC_SystemReset:
BX	LR
; end of stm32f10x_wwdg_NVIC_SystemReset
stm32f10x_wwdg_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_wwdg_ITM_SendChar31
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_wwdg_ITM_SendChar32
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_wwdg_ITM_SendChar33
L_stm32f10x_wwdg_ITM_SendChar27:
;core_cm3.h,1823 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f10x_wwdg_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f10x_wwdg_ITM_SendChar23
IT	AL
BAL	L_stm32f10x_wwdg_ITM_SendChar22
L_stm32f10x_wwdg_ITM_SendChar23:
...
;core_cm3.h,1820 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f10x_wwdg_ITM_SendChar30
L_stm32f10x_wwdg_ITM_SendChar31:
L_stm32f10x_wwdg_ITM_SendChar30:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_wwdg_ITM_SendChar29
L_stm32f10x_wwdg_ITM_SendChar32:
L_stm32f10x_wwdg_ITM_SendChar29:
;core_cm3.h,1821 :: 		(ITM->TER & (1ul << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_wwdg_ITM_SendChar28
L_stm32f10x_wwdg_ITM_SendChar33:
L_stm32f10x_wwdg_ITM_SendChar28:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f10x_wwdg_ITM_SendChar
stm32f10x_wwdg_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f10x_wwdg_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm3.h,1845 :: 		}
L_stm32f10x_wwdg_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_wwdg_ITM_ReceiveChar
stm32f10x_wwdg_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f10x_wwdg_ITM_CheckChar25
;core_cm3.h,1862 :: 		return (0);                                 /* no character available */
MOVW	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm3.h,1863 :: 		} else {
L_stm32f10x_wwdg_ITM_CheckChar25:
;core_cm3.h,1864 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm3.h,1866 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f10x_wwdg_ITM_CheckChar
_WWDG_DeInit:
;stm32f10x_wwdg.c,102 :: 		void WWDG_DeInit(void)
SUB	SP, SP, #4
STR	LR, [SP, #0]
;stm32f10x_wwdg.c,104 :: 		RCC_APB1PeriphResetCmd(RCC_APB1Periph_WWDG, ENABLE);
MOVS	R1, #1
MOV	R0, #2048
BL	_RCC_APB1PeriphResetCmd+0
;stm32f10x_wwdg.c,105 :: 		RCC_APB1PeriphResetCmd(RCC_APB1Periph_WWDG, DISABLE);
MOVS	R1, #0
MOV	R0, #2048
BL	_RCC_APB1PeriphResetCmd+0
;stm32f10x_wwdg.c,106 :: 		}
L_end_WWDG_DeInit:
LDR	LR, [SP, #0]
ADD	SP, SP, #4
BX	LR
; end of _WWDG_DeInit
_WWDG_SetPrescaler:
;stm32f10x_wwdg.c,118 :: 		void WWDG_SetPrescaler(uint32_t WWDG_Prescaler)
; WWDG_Prescaler start address is: 0 (R0)
; WWDG_Prescaler end address is: 0 (R0)
; WWDG_Prescaler start address is: 0 (R0)
;stm32f10x_wwdg.c,120 :: 		uint32_t tmpreg = 0;
;stm32f10x_wwdg.c,124 :: 		tmpreg = WWDG->CFR & CFR_WDGTB_Mask;
MOVW	R3, #11268
MOVT	R3, #16384
LDR	R2, [R3, #0]
MVN	R1, #384
AND	R1, R2, R1, LSL #0
;stm32f10x_wwdg.c,126 :: 		tmpreg |= WWDG_Prescaler;
ORRS	R1, R0
; WWDG_Prescaler end address is: 0 (R0)
;stm32f10x_wwdg.c,128 :: 		WWDG->CFR = tmpreg;
STR	R1, [R3, #0]
;stm32f10x_wwdg.c,129 :: 		}
L_end_WWDG_SetPrescaler:
BX	LR
; end of _WWDG_SetPrescaler
_WWDG_SetWindowValue:
;stm32f10x_wwdg.c,137 :: 		void WWDG_SetWindowValue(uint8_t WindowValue)
; WindowValue start address is: 0 (R0)
; WindowValue end address is: 0 (R0)
; WindowValue start address is: 0 (R0)
;stm32f10x_wwdg.c,139 :: 		__IO uint32_t tmpreg = 0;
;stm32f10x_wwdg.c,145 :: 		tmpreg = WWDG->CFR & CFR_W_Mask;
MOVW	R3, #11268
MOVT	R3, #16384
LDR	R2, [R3, #0]
MVN	R1, #127
...
MOV	R2, R1
;stm32f10x_wwdg.c,148 :: 		tmpreg |= WindowValue & (uint32_t) BIT_Mask;
AND	R1, R0, #127
; WindowValue end address is: 0 (R0)
ORR	R1, R2, R1, LSL #0
...
MOV	R0, R1
;stm32f10x_wwdg.c,151 :: 		WWDG->CFR = tmpreg;
STR	R0, [R3, #0]
; tmpreg end address is: 0 (R0)
;stm32f10x_wwdg.c,152 :: 		}
L_end_WWDG_SetWindowValue:
BX	LR
; end of _WWDG_SetWindowValue
_WWDG_EnableIT:
;stm32f10x_wwdg.c,159 :: 		void WWDG_EnableIT(void)
;stm32f10x_wwdg.c,161 :: 		*(__IO uint32_t *) CFR_EWI_BB = (uint32_t)ENABLE;
MOV	R1, #1
MOVW	R0, 1107656868
MOVT	R0, 16901
STR	R1, [R0, #0]
;stm32f10x_wwdg.c,162 :: 		}
L_end_WWDG_EnableIT:
BX	LR
; end of _WWDG_EnableIT
_WWDG_SetCounter:
;stm32f10x_wwdg.c,170 :: 		void WWDG_SetCounter(uint8_t Counter)
; Counter start address is: 0 (R0)
; Counter end address is: 0 (R0)
; Counter start address is: 0 (R0)
;stm32f10x_wwdg.c,176 :: 		WWDG->CR = Counter & BIT_Mask;
AND	R2, R0, #127
UXTB	R2, R2
; Counter end address is: 0 (R0)
MOVW	R1, #11264
MOVT	R1, #16384
STR	R2, [R1, #0]
;stm32f10x_wwdg.c,177 :: 		}
L_end_WWDG_SetCounter:
BX	LR
; end of _WWDG_SetCounter
_WWDG_Enable:
;stm32f10x_wwdg.c,185 :: 		void WWDG_Enable(uint8_t Counter)
; Counter start address is: 0 (R0)
; Counter end address is: 0 (R0)
; Counter start address is: 0 (R0)
;stm32f10x_wwdg.c,189 :: 		WWDG->CR = CR_WDGA_Set | Counter;
ORR	R2, R0, #128
; Counter end address is: 0 (R0)
MOVW	R1, #11264
MOVT	R1, #16384
STR	R2, [R1, #0]
;stm32f10x_wwdg.c,190 :: 		}
L_end_WWDG_Enable:
BX	LR
; end of _WWDG_Enable
_WWDG_GetFlagStatus:
;stm32f10x_wwdg.c,197 :: 		FlagStatus WWDG_GetFlagStatus(void)
;stm32f10x_wwdg.c,199 :: 		return (FlagStatus)(WWDG->SR);
MOVW	R0, #11272
MOVT	R0, #16384
LDRB	R0, [R0, #0]
;stm32f10x_wwdg.c,200 :: 		}
L_end_WWDG_GetFlagStatus:
BX	LR
; end of _WWDG_GetFlagStatus
_WWDG_ClearFlag:
;stm32f10x_wwdg.c,207 :: 		void WWDG_ClearFlag(void)
;stm32f10x_wwdg.c,209 :: 		WWDG->SR = (uint32_t)RESET;
MOV	R1, #0
MOVW	R0, #11272
MOVT	R0, #16384
STR	R1, [R0, #0]
;stm32f10x_wwdg.c,210 :: 		}
L_end_WWDG_ClearFlag:
BX	LR
; end of _WWDG_ClearFlag
