stm32f10x_pwr_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f10x_pwr_NVIC_SetPriorityGrouping
stm32f10x_pwr_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f10x_pwr_NVIC_GetPriorityGrouping
stm32f10x_pwr_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f10x_pwr_NVIC_EnableIRQ
stm32f10x_pwr_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f10x_pwr_NVIC_DisableIRQ
stm32f10x_pwr_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_pwr_NVIC_GetPendingIRQ0
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_GetPendingIRQ1
L_stm32f10x_pwr_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
L_stm32f10x_pwr_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_pwr_NVIC_GetPendingIRQ
stm32f10x_pwr_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f10x_pwr_NVIC_SetPendingIRQ
stm32f10x_pwr_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f10x_pwr_NVIC_ClearPendingIRQ
stm32f10x_pwr_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_pwr_NVIC_GetActive2
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_GetActive3
L_stm32f10x_pwr_NVIC_GetActive2:
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 end address is: 0 (R0)
L_stm32f10x_pwr_NVIC_GetActive3:
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_pwr_NVIC_GetActive?T72 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_pwr_NVIC_GetActive
stm32f10x_pwr_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_pwr_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f10x_pwr_NVIC_SetPriority5
L_stm32f10x_pwr_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f10x_pwr_NVIC_SetPriority5:
;core_cm3.h,1653 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f10x_pwr_NVIC_SetPriority
stm32f10x_pwr_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_pwr_NVIC_GetPriority6
...
L_stm32f10x_pwr_NVIC_GetPriority6:
...
BX	LR
; end of stm32f10x_pwr_NVIC_GetPriority
stm32f10x_pwr_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f10x_pwr_NVIC_EncodePriority8
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T112 start address is: 12 (R3)
MOVW	R3, #4
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T112 end address is: 12 (R3)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_EncodePriority9
L_stm32f10x_pwr_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T112 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T112 end address is: 0 (R0)
MOV	R3, R0
L_stm32f10x_pwr_NVIC_EncodePriority9:
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T112 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f10x_pwr_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T116 start address is: 20 (R5)
MOVW	R5, #0
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T116 end address is: 20 (R5)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_EncodePriority11
L_stm32f10x_pwr_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T116 start address is: 20 (R5)
; ?FLOC__stm32f10x_pwr_NVIC_EncodePriority?T116 end address is: 20 (R5)
L_stm32f10x_pwr_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f10x_pwr_NVIC_EncodePriority
stm32f10x_pwr_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f10x_pwr_NVIC_DecodePriority12
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T130 start address is: 16 (R4)
MOVW	R4, #4
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T130 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_DecodePriority13
L_stm32f10x_pwr_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T130 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T130 end address is: 4 (R1)
MOV	R4, R1
L_stm32f10x_pwr_NVIC_DecodePriority13:
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T130 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f10x_pwr_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T134 start address is: 16 (R4)
MOVW	R4, #0
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T134 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_pwr_NVIC_DecodePriority15
L_stm32f10x_pwr_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T134 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T134 end address is: 20 (R5)
MOV	R4, R5
L_stm32f10x_pwr_NVIC_DecodePriority15:
; ?FLOC__stm32f10x_pwr_NVIC_DecodePriority?T134 start address is: 16 (R4)
...
BX	LR
; end of stm32f10x_pwr_NVIC_DecodePriority
stm32f10x_pwr_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f10x_pwr_SysTick_Config16
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f10x_pwr_SysTick_Config16:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f10x_pwr_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_pwr_SysTick_Config
stm32f10x_pwr_NVIC_SystemReset:
...
L_stm32f10x_pwr_NVIC_SystemReset17:
IT	AL
BAL	L_stm32f10x_pwr_NVIC_SystemReset17
;core_cm3.h,1787 :: 		}
L_end_NVIC_SystemReset:
BX	LR
; end of stm32f10x_pwr_NVIC_SystemReset
stm32f10x_pwr_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_pwr_ITM_SendChar35
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_pwr_ITM_SendChar36
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_pwr_ITM_SendChar37
L_stm32f10x_pwr_ITM_SendChar31:
;core_cm3.h,1823 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f10x_pwr_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f10x_pwr_ITM_SendChar23
IT	AL
BAL	L_stm32f10x_pwr_ITM_SendChar22
L_stm32f10x_pwr_ITM_SendChar23:
...
;core_cm3.h,1820 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f10x_pwr_ITM_SendChar34
L_stm32f10x_pwr_ITM_SendChar35:
L_stm32f10x_pwr_ITM_SendChar34:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_pwr_ITM_SendChar33
L_stm32f10x_pwr_ITM_SendChar36:
L_stm32f10x_pwr_ITM_SendChar33:
;core_cm3.h,1821 :: 		(ITM->TER & (1ul << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_pwr_ITM_SendChar32
L_stm32f10x_pwr_ITM_SendChar37:
L_stm32f10x_pwr_ITM_SendChar32:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f10x_pwr_ITM_SendChar
stm32f10x_pwr_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f10x_pwr_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm3.h,1845 :: 		}
L_stm32f10x_pwr_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_pwr_ITM_ReceiveChar
stm32f10x_pwr_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f10x_pwr_ITM_CheckChar25
;core_cm3.h,1862 :: 		return (0);                                 /* no character available */
MOVW	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm3.h,1863 :: 		} else {
L_stm32f10x_pwr_ITM_CheckChar25:
;core_cm3.h,1864 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm3.h,1866 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f10x_pwr_ITM_CheckChar
_PWR_DeInit:
;stm32f10x_pwr.c,112 :: 		void PWR_DeInit(void)
SUB	SP, SP, #4
STR	LR, [SP, #0]
;stm32f10x_pwr.c,114 :: 		RCC_APB1PeriphResetCmd(RCC_APB1Periph_PWR, ENABLE);
MOVS	R1, #1
MOV	R0, #268435456
BL	_RCC_APB1PeriphResetCmd+0
;stm32f10x_pwr.c,115 :: 		RCC_APB1PeriphResetCmd(RCC_APB1Periph_PWR, DISABLE);
MOVS	R1, #0
MOV	R0, #268435456
BL	_RCC_APB1PeriphResetCmd+0
;stm32f10x_pwr.c,116 :: 		}
...
;stm32f10x_pwr.c,124 :: 		void PWR_BackupAccessCmd(FunctionalState NewState)
; NewState start address is: 0 (R0)
; NewState end address is: 0 (R0)
; NewState start address is: 0 (R0)
;stm32f10x_pwr.c,128 :: 		*(__IO uint32_t *) CR_DBP_BB = (uint32_t)NewState;
UXTB	R2, R0
; NewState end address is: 0 (R0)
MOVW	R1, 1108213792
MOVT	R1, 16910
...
_PWR_PVDCmd:
;stm32f10x_pwr.c,137 :: 		void PWR_PVDCmd(FunctionalState NewState)
; NewState start address is: 0 (R0)
; NewState end address is: 0 (R0)
; NewState start address is: 0 (R0)
;stm32f10x_pwr.c,141 :: 		*(__IO uint32_t *) CR_PVDE_BB = (uint32_t)NewState;
UXTB	R2, R0
; NewState end address is: 0 (R0)
MOVW	R1, 1108213776
MOVT	R1, 16910
...
; end of _PWR_PVDCmd
_PWR_PVDLevelConfig:
;stm32f10x_pwr.c,158 :: 		void PWR_PVDLevelConfig(uint32_t PWR_PVDLevel)
; PWR_PVDLevel start address is: 0 (R0)
; PWR_PVDLevel end address is: 0 (R0)
; PWR_PVDLevel start address is: 0 (R0)
;stm32f10x_pwr.c,160 :: 		uint32_t tmpreg = 0;
;stm32f10x_pwr.c,165 :: 		tmpreg &= CR_PLS_MASK;
MOVW	R3, #28672
MOVT	R3, #16384
LDR	R2, [R3, #0]
MVN	R1, #224
AND	R1, R2, R1, LSL #0
;stm32f10x_pwr.c,167 :: 		tmpreg |= PWR_PVDLevel;
ORRS	R1, R0
; PWR_PVDLevel end address is: 0 (R0)
;stm32f10x_pwr.c,169 :: 		PWR->CR = tmpreg;
STR	R1, [R3, #0]
;stm32f10x_pwr.c,170 :: 		}
...
_PWR_WakeUpPinCmd:
;stm32f10x_pwr.c,178 :: 		void PWR_WakeUpPinCmd(FunctionalState NewState)
; NewState start address is: 0 (R0)
; NewState end address is: 0 (R0)
; NewState start address is: 0 (R0)
;stm32f10x_pwr.c,182 :: 		*(__IO uint32_t *) CSR_EWUP_BB = (uint32_t)NewState;
UXTB	R2, R0
; NewState end address is: 0 (R0)
MOVW	R1, 1108213920
MOVT	R1, 16910
...
_PWR_EnterSTOPMode:
;stm32f10x_pwr.c,197 :: 		void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
...
; PWR_Regulator start address is: 0 (R0)
; PWR_STOPEntry start address is: 4 (R1)
;stm32f10x_pwr.c,199 :: 		uint32_t tmpreg = 0;
;stm32f10x_pwr.c,207 :: 		tmpreg &= CR_DS_MASK;
MOVW	R4, #28672
MOVT	R4, #16384
LDR	R3, [R4, #0]
MVN	R2, #3
AND	R2, R3, R2, LSL #0
;stm32f10x_pwr.c,209 :: 		tmpreg |= PWR_Regulator;
ORRS	R2, R0
; PWR_Regulator end address is: 0 (R0)
;stm32f10x_pwr.c,211 :: 		PWR->CR = tmpreg;
STR	R2, [R4, #0]
;stm32f10x_pwr.c,213 :: 		SCB->SCR |= SCB_SCR_SLEEPDEEP;
MOVW	R3, #60688
MOVT	R3, #57344
LDR	R2, [R3, #0]
ORR	R2, R2, #4
STR	R2, [R3, #0]
;stm32f10x_pwr.c,216 :: 		if(PWR_STOPEntry == PWR_STOPEntry_WFI)
CMP	R1, #1
IT	NE
BNE	L_PWR_EnterSTOPMode27
; PWR_STOPEntry end address is: 4 (R1)
;stm32f10x_pwr.c,219 :: 		asm { wfi };
WFI
;stm32f10x_pwr.c,220 :: 		}
IT	AL
BAL	L_PWR_EnterSTOPMode28
L_PWR_EnterSTOPMode27:
;stm32f10x_pwr.c,224 :: 		asm { wfe };
WFE
;stm32f10x_pwr.c,225 :: 		}
L_PWR_EnterSTOPMode28:
;stm32f10x_pwr.c,228 :: 		SCB->SCR &= (uint32_t)~((uint32_t)SCB_SCR_SLEEPDEEP);
MOVW	R4, #60688
MOVT	R4, #57344
LDR	R3, [R4, #0]
MVN	R2, #4
...
;stm32f10x_pwr.c,236 :: 		void PWR_EnterSTANDBYMode(void)
;stm32f10x_pwr.c,239 :: 		PWR->CR |= PWR_CR_CWUF;
MOVW	R1, #28672
MOVT	R1, #16384
LDR	R0, [R1, #0]
ORR	R0, R0, #4
STR	R0, [R1, #0]
;stm32f10x_pwr.c,241 :: 		PWR->CR |= PWR_CR_PDDS;
ORR	R0, R0, #2
STR	R0, [R1, #0]
;stm32f10x_pwr.c,243 :: 		SCB->SCR |= SCB_SCR_SLEEPDEEP;
MOVW	R1, #60688
MOVT	R1, #57344
LDR	R0, [R1, #0]
ORR	R0, R0, #4
STR	R0, [R1, #0]
;stm32f10x_pwr.c,249 :: 		asm {wfi};
WFI
;stm32f10x_pwr.c,250 :: 		}
...
_PWR_GetFlagStatus:
;stm32f10x_pwr.c,261 :: 		FlagStatus PWR_GetFlagStatus(uint32_t PWR_FLAG)
; PWR_FLAG start address is: 0 (R0)
; PWR_FLAG end address is: 0 (R0)
; PWR_FLAG start address is: 0 (R0)
;stm32f10x_pwr.c,263 :: 		FlagStatus bitstatus = RESET;
;stm32f10x_pwr.c,267 :: 		if ((PWR->CSR & PWR_FLAG) != (uint32_t)RESET)
MOVW	R1, #28676
MOVT	R1, #16384
LDR	R1, [R1, #0]
ANDS	R1, R0
...
CMP	R1, #0
IT	EQ
BEQ	L_PWR_GetFlagStatus29
;stm32f10x_pwr.c,269 :: 		bitstatus = SET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #1
;stm32f10x_pwr.c,270 :: 		}
; bitstatus end address is: 0 (R0)
IT	AL
BAL	L_PWR_GetFlagStatus30
L_PWR_GetFlagStatus29:
;stm32f10x_pwr.c,273 :: 		bitstatus = RESET;
; bitstatus start address is: 0 (R0)
MOVS	R0, #0
; bitstatus end address is: 0 (R0)
;stm32f10x_pwr.c,274 :: 		}
L_PWR_GetFlagStatus30:
;stm32f10x_pwr.c,276 :: 		return bitstatus;
; bitstatus start address is: 0 (R0)
; bitstatus end address is: 0 (R0)
;stm32f10x_pwr.c,277 :: 		}
...
_PWR_ClearFlag:
;stm32f10x_pwr.c,287 :: 		void PWR_ClearFlag(uint32_t PWR_FLAG)
; PWR_FLAG start address is: 0 (R0)
; PWR_FLAG end address is: 0 (R0)
; PWR_FLAG start address is: 0 (R0)
;stm32f10x_pwr.c,292 :: 		PWR->CR |=  PWR_FLAG << 2;
LSLS	R3, R0, #2
; PWR_FLAG end address is: 0 (R0)
MOVW	R2, #28672
MOVT	R2, #16384
