stm32f10x_crc_NVIC_SetPriorityGrouping:
...
BX	LR
; end of stm32f10x_crc_NVIC_SetPriorityGrouping
stm32f10x_crc_NVIC_GetPriorityGrouping:
...
BX	LR
; end of stm32f10x_crc_NVIC_GetPriorityGrouping
stm32f10x_crc_NVIC_EnableIRQ:
...
BX	LR
; end of stm32f10x_crc_NVIC_EnableIRQ
stm32f10x_crc_NVIC_DisableIRQ:
...
BX	LR
; end of stm32f10x_crc_NVIC_DisableIRQ
stm32f10x_crc_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_crc_NVIC_GetPendingIRQ0
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_crc_NVIC_GetPendingIRQ1
L_stm32f10x_crc_NVIC_GetPendingIRQ0:
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
L_stm32f10x_crc_NVIC_GetPendingIRQ1:
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_crc_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_crc_NVIC_GetPendingIRQ
stm32f10x_crc_NVIC_SetPendingIRQ:
...
BX	LR
; end of stm32f10x_crc_NVIC_SetPendingIRQ
stm32f10x_crc_NVIC_ClearPendingIRQ:
...
BX	LR
; end of stm32f10x_crc_NVIC_ClearPendingIRQ
stm32f10x_crc_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_crc_NVIC_GetActive2
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_crc_NVIC_GetActive3
L_stm32f10x_crc_NVIC_GetActive2:
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 end address is: 0 (R0)
L_stm32f10x_crc_NVIC_GetActive3:
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__stm32f10x_crc_NVIC_GetActive?T72 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of stm32f10x_crc_NVIC_GetActive
stm32f10x_crc_NVIC_SetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_crc_NVIC_SetPriority4
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_stm32f10x_crc_NVIC_SetPriority5
L_stm32f10x_crc_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_stm32f10x_crc_NVIC_SetPriority5:
;core_cm3.h,1653 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of stm32f10x_crc_NVIC_SetPriority
stm32f10x_crc_NVIC_GetPriority:
...
CMP	R0, #0
IT	GE
BGE	L_stm32f10x_crc_NVIC_GetPriority6
...
L_stm32f10x_crc_NVIC_GetPriority6:
...
BX	LR
; end of stm32f10x_crc_NVIC_GetPriority
stm32f10x_crc_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_stm32f10x_crc_NVIC_EncodePriority8
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T112 start address is: 12 (R3)
MOVW	R3, #4
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T112 end address is: 12 (R3)
IT	AL
BAL	L_stm32f10x_crc_NVIC_EncodePriority9
L_stm32f10x_crc_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T112 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T112 end address is: 0 (R0)
MOV	R3, R0
L_stm32f10x_crc_NVIC_EncodePriority9:
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T112 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_stm32f10x_crc_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T116 start address is: 20 (R5)
MOVW	R5, #0
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T116 end address is: 20 (R5)
IT	AL
BAL	L_stm32f10x_crc_NVIC_EncodePriority11
L_stm32f10x_crc_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T116 start address is: 20 (R5)
; ?FLOC__stm32f10x_crc_NVIC_EncodePriority?T116 end address is: 20 (R5)
L_stm32f10x_crc_NVIC_EncodePriority11:
...
BX	LR
; end of stm32f10x_crc_NVIC_EncodePriority
stm32f10x_crc_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_stm32f10x_crc_NVIC_DecodePriority12
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T130 start address is: 16 (R4)
MOVW	R4, #4
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T130 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_crc_NVIC_DecodePriority13
L_stm32f10x_crc_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T130 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T130 end address is: 4 (R1)
MOV	R4, R1
L_stm32f10x_crc_NVIC_DecodePriority13:
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T130 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_stm32f10x_crc_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T134 start address is: 16 (R4)
MOVW	R4, #0
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T134 end address is: 16 (R4)
IT	AL
BAL	L_stm32f10x_crc_NVIC_DecodePriority15
L_stm32f10x_crc_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T134 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T134 end address is: 20 (R5)
MOV	R4, R5
L_stm32f10x_crc_NVIC_DecodePriority15:
; ?FLOC__stm32f10x_crc_NVIC_DecodePriority?T134 start address is: 16 (R4)
...
BX	LR
; end of stm32f10x_crc_NVIC_DecodePriority
stm32f10x_crc_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_stm32f10x_crc_SysTick_Config16
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_stm32f10x_crc_SysTick_Config16:
...
MOVS	R0, #-1
SXTB	R0, R0
BL	stm32f10x_crc_NVIC_SetPriority+0
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_crc_SysTick_Config
stm32f10x_crc_NVIC_SystemReset:
...
L_stm32f10x_crc_NVIC_SystemReset17:
IT	AL
BAL	L_stm32f10x_crc_NVIC_SystemReset17
;core_cm3.h,1787 :: 		}
L_end_NVIC_SystemReset:
BX	LR
; end of stm32f10x_crc_NVIC_SystemReset
stm32f10x_crc_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_crc_ITM_SendChar34
MOVW	R1, #3712
MOVT	R1, #57344
LDR	R1, [R1, #0]
AND	R1, R1, #1
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_crc_ITM_SendChar35
...
CMP	R1, #0
IT	EQ
BEQ	L_stm32f10x_crc_ITM_SendChar36
L_stm32f10x_crc_ITM_SendChar30:
;core_cm3.h,1823 :: 		while (ITM->PORT[0].u32 == 0);
L_stm32f10x_crc_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_stm32f10x_crc_ITM_SendChar23
IT	AL
BAL	L_stm32f10x_crc_ITM_SendChar22
L_stm32f10x_crc_ITM_SendChar23:
...
;core_cm3.h,1820 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_stm32f10x_crc_ITM_SendChar33
L_stm32f10x_crc_ITM_SendChar34:
L_stm32f10x_crc_ITM_SendChar33:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_crc_ITM_SendChar32
L_stm32f10x_crc_ITM_SendChar35:
L_stm32f10x_crc_ITM_SendChar32:
;core_cm3.h,1821 :: 		(ITM->TER & (1ul << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_stm32f10x_crc_ITM_SendChar31
L_stm32f10x_crc_ITM_SendChar36:
L_stm32f10x_crc_ITM_SendChar31:
...
L_end_ITM_SendChar:
BX	LR
; end of stm32f10x_crc_ITM_SendChar
stm32f10x_crc_ITM_ReceiveChar:
...
CMP	R1, R0
IT	EQ
BEQ	L_stm32f10x_crc_ITM_ReceiveChar24
...
STR	R1, [R0, #0]
;core_cm3.h,1845 :: 		}
L_stm32f10x_crc_ITM_ReceiveChar24:
...
ADD	SP, SP, #4
BX	LR
; end of stm32f10x_crc_ITM_ReceiveChar
stm32f10x_crc_ITM_CheckChar:
...
CMP	R1, R0
IT	NE
BNE	L_stm32f10x_crc_ITM_CheckChar25
;core_cm3.h,1862 :: 		return (0);                                 /* no character available */
MOVW	R0, #0
IT	AL
BAL	L_end_ITM_CheckChar
;core_cm3.h,1863 :: 		} else {
L_stm32f10x_crc_ITM_CheckChar25:
;core_cm3.h,1864 :: 		return (1);                                 /*    character available */
MOVS	R0, #1
;core_cm3.h,1866 :: 		}
L_end_ITM_CheckChar:
BX	LR
; end of stm32f10x_crc_ITM_CheckChar
_CRC_ResetDR:
;stm32f10x_crc.c,83 :: 		void CRC_ResetDR(void)
;stm32f10x_crc.c,86 :: 		CRC->CR = CRC_CR_RESET;
MOVS	R1, #1
MOVW	R0, #12296
MOVT	R0, #16386
STR	R1, [R0, #0]
...
; end of _CRC_ResetDR
_CRC_CalcCRC:
;stm32f10x_crc.c,94 :: 		uint32_t CRC_CalcCRC(uint32_t Data)
; Data start address is: 0 (R0)
; Data end address is: 0 (R0)
; Data start address is: 0 (R0)
;stm32f10x_crc.c,96 :: 		CRC->DR = Data;
MOVW	R1, #12288
MOVT	R1, #16386
STR	R0, [R1, #0]
;stm32f10x_crc.c,98 :: 		return (CRC->DR);
; Data end address is: 0 (R0)
;stm32f10x_crc.c,99 :: 		}
L_end_CRC_CalcCRC:
BX	LR
; end of _CRC_CalcCRC
_CRC_CalcBlockCRC:
;stm32f10x_crc.c,107 :: 		uint32_t CRC_CalcBlockCRC(uint32_t pBuffer[], uint32_t BufferLength)
...
;stm32f10x_crc.c,109 :: 		uint32_t index = 0;
;stm32f10x_crc.c,111 :: 		for(index = 0; index < BufferLength; index++)
...
; pBuffer end address is: 4 (R1)
;stm32f10x_crc.c,113 :: 		CRC->DR = pBuffer[index];
; pBuffer start address is: 4 (R1)
LSLS	R2, R4, #2
ADDS	R2, R1, R2
LDR	R3, [R2, #0]
...
;stm32f10x_crc.c,115 :: 		return (CRC->DR);
MOVW	R2, #12288
MOVT	R2, #16386
LDR	R0, [R2, #0]
;stm32f10x_crc.c,116 :: 		}
...
_CRC_GetCRC:
;stm32f10x_crc.c,123 :: 		uint32_t CRC_GetCRC(void)
;stm32f10x_crc.c,125 :: 		return (CRC->DR);
MOVW	R0, #12288
MOVT	R0, #16386
LDR	R0, [R0, #0]
;stm32f10x_crc.c,126 :: 		}
...
; end of _CRC_GetCRC
_CRC_SetIDRegister:
;stm32f10x_crc.c,133 :: 		void CRC_SetIDRegister(uint8_t IDValue)
; IDValue start address is: 0 (R0)
; IDValue end address is: 0 (R0)
; IDValue start address is: 0 (R0)
;stm32f10x_crc.c,135 :: 		CRC->IDR = IDValue;
MOVW	R1, #12292
MOVT	R1, #16386
STRB	R0, [R1, #0]
; IDValue end address is: 0 (R0)
...
_CRC_GetIDRegister:
;stm32f10x_crc.c,143 :: 		uint8_t CRC_GetIDRegister(void)
;stm32f10x_crc.c,145 :: 		return (CRC->IDR);
MOVW	R0, #12292
MOVT	R0, #16386
LDRB	R0, [R0, #0]
;stm32f10x_crc.c,146 :: 		}
