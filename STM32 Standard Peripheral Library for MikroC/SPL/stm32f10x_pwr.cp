#line 1 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
...
#line 112 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_DeInit(void)
{
 RCC_APB1PeriphResetCmd( ((uint32_t)0x10000000) , ENABLE);
 RCC_APB1PeriphResetCmd( ((uint32_t)0x10000000) , DISABLE);
}
#line 124 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_BackupAccessCmd(FunctionalState NewState)
{

  ((void)0) ;
 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7000)  - ((uint32_t)0x40000000) )  + 0x00)  * 32) + ( 0x08  * 4))  = (uint32_t)NewState;
}
#line 137 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_PVDCmd(FunctionalState NewState)
{

  ((void)0) ;
 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7000)  - ((uint32_t)0x40000000) )  + 0x00)  * 32) + ( 0x04  * 4))  = (uint32_t)NewState;
}
#line 158 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_PVDLevelConfig(uint32_t PWR_PVDLevel)
{
 uint32_t tmpreg = 0;

  ((void)0) ;
 tmpreg =  ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CR;

 tmpreg &=  ((uint32_t)0xFFFFFF1F) ;

 tmpreg |= PWR_PVDLevel;

  ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CR = tmpreg;
}
#line 178 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_WakeUpPinCmd(FunctionalState NewState)
{

  ((void)0) ;
 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7000)  - ((uint32_t)0x40000000) )  + 0x04)  * 32) + ( 0x08  * 4))  = (uint32_t)NewState;
}
#line 197 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_EnterSTOPMode(uint32_t PWR_Regulator, uint8_t PWR_STOPEntry)
{
 uint32_t tmpreg = 0;
 ...
 tmpreg |= PWR_Regulator;
  ...
  ((SCB_Type *) ( (0xE000E000)  + 0x0D00) ) ->SCR |=  ((uint8_t)0x04) ;


 if(PWR_STOPEntry ==  ((uint8_t)0x01) )
 {
 ...
 asm { wfe };
  ...
  ((SCB_Type *) ( (0xE000E000)  + 0x0D00) ) ->SCR &= (uint32_t)~((uint32_t) ((uint8_t)0x04) );
}
#line 236 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_EnterSTANDBYMode(void)
{

  ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CR |=  ((uint16_t)0x0004) ;

  ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CR |=  ((uint16_t)0x0002) ;

  ((SCB_Type *) ( (0xE000E000)  + 0x0D00) ) ->SCR |=  ((uint8_t)0x04) ;
#line 249 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
 asm {wfi};
}
#line 261 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
FlagStatus PWR_GetFlagStatus(uint32_t PWR_FLAG)
{
 ...
 if (( ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CSR & PWR_FLAG) != (uint32_t)RESET)
 {
 bitstatus = SET;
 }
 else
...
#line 287 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_pwr.c"
void PWR_ClearFlag(uint32_t PWR_FLAG)
{

  ((void)0) ;

  ((PWR_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7000) ) ->CR |= PWR_FLAG << 2;
}
