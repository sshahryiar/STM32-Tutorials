#line 1 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
...
#line 118 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_DeInit(void)
{

 RCC_APB1PeriphResetCmd( ((uint32_t)0x40000000) , ENABLE);

 RCC_APB1PeriphResetCmd( ((uint32_t)0x40000000) , DISABLE);
}
#line 135 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_Init(CEC_InitTypeDef* CEC_InitStruct)
{
 uint16_t tmpreg = 0;
 ...
 tmpreg =  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CFGR;
 ...
 tmpreg |= (uint16_t)(CEC_InitStruct->CEC_BitTimingMode | CEC_InitStruct->CEC_BitPeriodMode);
  ...
  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CFGR = tmpreg;

}
#line 164 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_Cmd(FunctionalState NewState)
{

  ((void)0) ;

 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7800)  - ((uint32_t)0x40000000) )  + 0x00)  * 32) + ( 0x00  * 4))  = (uint32_t)NewState;

 if(NewState == DISABLE)
 {

 while(( ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CFGR &  ((uint16_t)0x0001) ) != (uint32_t)RESET)
 {
 }
 }
}
#line 186 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_ITConfig(FunctionalState NewState)
{

  ((void)0) ;

 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7800)  - ((uint32_t)0x40000000) )  + 0x00)  * 32) + ( 0x01  * 4))  = (uint32_t)NewState;
}
#line 199 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_OwnAddressConfig(uint8_t CEC_OwnAddress)
{
  ...
  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->OAR = CEC_OwnAddress;
}
#line 213 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_SetPrescaler(uint16_t CEC_Prescaler)
{
  ...
  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->PRES = CEC_Prescaler;
}
#line 227 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_SendDataByte(uint8_t Data)
{

  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->TXD = Data ;
}
#line 239 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
uint8_t CEC_ReceiveDataByte(void)
{

 return (uint8_t)( ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->RXD);
}
#line 250 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_StartOfMessage(void)
{

 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7800)  - ((uint32_t)0x40000000) )  + 0x10)  * 32) + ( 0x00  * 4))  = (uint32_t)0x1;
}
#line 262 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_EndOfMessageCmd(FunctionalState NewState)
{
 ...
 *( volatile  uint32_t *)  ( ((uint32_t)0x42000000)  + ( ( ( ( ((uint32_t)0x40000000)  + 0x7800)  - ((uint32_t)0x40000000) )  + 0x10)  * 32) + ( 0x01  * 4))  = (uint32_t)NewState;
}
#line 291 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
FlagStatus CEC_GetFlagStatus(uint32_t CEC_FLAG)
{
 ...
 cecbase = (uint32_t)( ( ((uint32_t)0x40000000)  + 0x7800) );


 cecreg = CEC_FLAG >> 28;


 CEC_FLAG &=  ((uint32_t)0x00FFFFFF) ;
 ...
 if(((*( volatile  uint32_t *)cecbase) & CEC_FLAG) != (uint32_t)RESET)
 {
...
#line 349 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_ClearFlag(uint32_t CEC_FLAG)
{
 uint32_t tmp = 0x0;
 ...
 tmp =  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CSR & 0x2;


  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CSR &= (uint32_t)(((~(uint32_t)CEC_FLAG) & 0xFFFFFFFC) | tmp);
}
#line 372 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
ITStatus CEC_GetITStatus(uint8_t CEC_IT)
{
 ...
 enablestatus = ( ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CFGR & (uint8_t) ((uint16_t)0x0002) ) ;


 if ((( ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CSR & CEC_IT) != (uint32_t)RESET) && enablestatus)
 {
...
#line 408 "C:/Users/Shawon&Nipa/Desktop/STM32F10x_StdPeriph_Lib/SPL/stm32f10x_cec.c"
void CEC_ClearITPendingBit(uint16_t CEC_IT)
{
 uint32_t tmp = 0x0;
 ...
 tmp =  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CSR & 0x2;
  ...
  ((CEC_TypeDef *) ( ((uint32_t)0x40000000)  + 0x7800) ) ->CSR &= (uint32_t)(((~(uint32_t)CEC_IT) & 0xFFFFFFFC) | tmp);
}
