...
BX	LR
; end of test_NVIC_SetPriorityGrouping
test_NVIC_GetPriorityGrouping:
...
BX	LR
; end of test_NVIC_GetPriorityGrouping
test_NVIC_EnableIRQ:
...
BX	LR
; end of test_NVIC_EnableIRQ
test_NVIC_DisableIRQ:
...
BX	LR
; end of test_NVIC_DisableIRQ
test_NVIC_GetPendingIRQ:
...
CMP	R1, #0
IT	EQ
BEQ	L_test_NVIC_GetPendingIRQ0
; ?FLOC__test_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__test_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
IT	AL
BAL	L_test_NVIC_GetPendingIRQ1
L_test_NVIC_GetPendingIRQ0:
; ?FLOC__test_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__test_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
L_test_NVIC_GetPendingIRQ1:
; ?FLOC__test_NVIC_GetPendingIRQ?T41 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__test_NVIC_GetPendingIRQ?T41 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of test_NVIC_GetPendingIRQ
test_NVIC_SetPendingIRQ:
...
BX	LR
; end of test_NVIC_SetPendingIRQ
test_NVIC_ClearPendingIRQ:
...
BX	LR
; end of test_NVIC_ClearPendingIRQ
test_NVIC_GetActive:
...
CMP	R1, #0
IT	EQ
BEQ	L_test_NVIC_GetActive2
; ?FLOC__test_NVIC_GetActive?T72 start address is: 0 (R0)
MOVS	R0, #1
SXTH	R0, R0
; ?FLOC__test_NVIC_GetActive?T72 end address is: 0 (R0)
IT	AL
BAL	L_test_NVIC_GetActive3
L_test_NVIC_GetActive2:
; ?FLOC__test_NVIC_GetActive?T72 start address is: 0 (R0)
MOVW	R0, #0
SXTH	R0, R0
; ?FLOC__test_NVIC_GetActive?T72 end address is: 0 (R0)
L_test_NVIC_GetActive3:
; ?FLOC__test_NVIC_GetActive?T72 start address is: 0 (R0)
SXTH	R1, R0
; ?FLOC__test_NVIC_GetActive?T72 end address is: 0 (R0)
MOV	R0, R1
...
BX	LR
; end of test_NVIC_GetActive
test_NVIC_SetPriority:
...
STRB	R2, [R3, #0]
IT	AL
BAL	L_test_NVIC_SetPriority5
L_test_NVIC_SetPriority4:
...
AND	R2, R2, #255
STRB	R2, [R3, #0]
L_test_NVIC_SetPriority5:
;core_cm3.h,1653 :: 		}
L_end_NVIC_SetPriority:
BX	LR
; end of test_NVIC_SetPriority
test_NVIC_GetPriority:
...
BX	LR
; end of test_NVIC_GetPriority
test_NVIC_EncodePriority:
...
CMP	R3, #4
IT	LS
BLS	L_test_NVIC_EncodePriority8
; ?FLOC__test_NVIC_EncodePriority?T112 start address is: 12 (R3)
MOVW	R3, #4
; ?FLOC__test_NVIC_EncodePriority?T112 end address is: 12 (R3)
IT	AL
BAL	L_test_NVIC_EncodePriority9
L_test_NVIC_EncodePriority8:
RSB	R3, R4, #7
; ?FLOC__test_NVIC_EncodePriority?T112 start address is: 0 (R0)
MOV	R0, R3
; ?FLOC__test_NVIC_EncodePriority?T112 end address is: 0 (R0)
MOV	R3, R0
L_test_NVIC_EncodePriority9:
; ?FLOC__test_NVIC_EncodePriority?T112 start address is: 12 (R3)
...
CMP	R3, #7
IT	CS
BCS	L_test_NVIC_EncodePriority10
; PriorityGroupTmp end address is: 16 (R4)
; ?FLOC__test_NVIC_EncodePriority?T116 start address is: 20 (R5)
MOVW	R5, #0
; ?FLOC__test_NVIC_EncodePriority?T116 end address is: 20 (R5)
IT	AL
BAL	L_test_NVIC_EncodePriority11
L_test_NVIC_EncodePriority10:
; PriorityGroupTmp start address is: 16 (R4)
SUBS	R5, R4, #7
; PriorityGroupTmp end address is: 16 (R4)
ADDS	R5, R5, #4
...
BX	LR
; end of test_NVIC_EncodePriority
test_NVIC_DecodePriority:
...
CMP	R4, #4
IT	LS
BLS	L_test_NVIC_DecodePriority12
; ?FLOC__test_NVIC_DecodePriority?T130 start address is: 16 (R4)
MOVW	R4, #4
; ?FLOC__test_NVIC_DecodePriority?T130 end address is: 16 (R4)
IT	AL
BAL	L_test_NVIC_DecodePriority13
L_test_NVIC_DecodePriority12:
RSB	R4, R5, #7
; ?FLOC__test_NVIC_DecodePriority?T130 start address is: 4 (R1)
MOV	R1, R4
; ?FLOC__test_NVIC_DecodePriority?T130 end address is: 4 (R1)
MOV	R4, R1
L_test_NVIC_DecodePriority13:
; ?FLOC__test_NVIC_DecodePriority?T130 start address is: 16 (R4)
...
CMP	R4, #7
IT	CS
BCS	L_test_NVIC_DecodePriority14
; PriorityGroupTmp end address is: 20 (R5)
; ?FLOC__test_NVIC_DecodePriority?T134 start address is: 16 (R4)
MOVW	R4, #0
; ?FLOC__test_NVIC_DecodePriority?T134 end address is: 16 (R4)
IT	AL
BAL	L_test_NVIC_DecodePriority15
L_test_NVIC_DecodePriority14:
; PriorityGroupTmp start address is: 20 (R5)
SUBS	R4, R5, #7
; PriorityGroupTmp end address is: 20 (R5)
ADDS	R4, R4, #4
; ?FLOC__test_NVIC_DecodePriority?T134 start address is: 20 (R5)
MOV	R5, R4
; ?FLOC__test_NVIC_DecodePriority?T134 end address is: 20 (R5)
MOV	R4, R5
L_test_NVIC_DecodePriority15:
; ?FLOC__test_NVIC_DecodePriority?T134 start address is: 16 (R4)
...
BX	LR
; end of test_NVIC_DecodePriority
test_SysTick_Config:
...
CMP	R0, R1
IT	LS
BLS	L_test_SysTick_Config16
; ticks end address is: 0 (R0)
MOVS	R0, #1
IT	AL
BAL	L_end_SysTick_Config
L_test_SysTick_Config16:
...
ADD	SP, SP, #4
BX	LR
; end of test_SysTick_Config
test_NVIC_SystemReset:
...
L_test_NVIC_SystemReset17:
IT	AL
BAL	L_test_NVIC_SystemReset17
;core_cm3.h,1787 :: 		}
L_end_NVIC_SystemReset:
BX	LR
; end of test_NVIC_SystemReset
test_ITM_SendChar:
...
CMP	R1, #0
IT	EQ
BEQ	L_test_ITM_SendChar37
L_test_ITM_SendChar31:
;core_cm3.h,1823 :: 		while (ITM->PORT[0].u32 == 0);
L_test_ITM_SendChar22:
; ch end address is: 0 (R0)
; ch start address is: 0 (R0)
MOVW	R1, #0
MOVT	R1, #57344
...
CMP	R1, #0
IT	NE
BNE	L_test_ITM_SendChar23
IT	AL
BAL	L_test_ITM_SendChar22
L_test_ITM_SendChar23:
...
;core_cm3.h,1820 :: 		(ITM->TCR & ITM_TCR_ITMENA_Msk)                  &&      /* ITM enabled */
IT	AL
BAL	L_test_ITM_SendChar34
L_test_ITM_SendChar35:
L_test_ITM_SendChar34:
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_test_ITM_SendChar33
L_test_ITM_SendChar36:
L_test_ITM_SendChar33:
;core_cm3.h,1821 :: 		(ITM->TER & (1ul << 0)        )                    )     /* ITM Port #0 enabled */
; ch start address is: 0 (R0)
; ch end address is: 0 (R0)
IT	AL
BAL	L_test_ITM_SendChar32
L_test_ITM_SendChar37:
L_test_ITM_SendChar32:
...
L_end_ITM_SendChar:
BX	LR
; end of test_ITM_SendChar
test_ITM_ReceiveChar:
