...
#define set_ADC1_AWD_channel(channel)                                                    do{ADC1_CR1 |= 0xFFFFFFE0; ADC1_CR1 |= 0x0000001F;}while(0)
...
#define set_ADC2_sample_time(value, channel)                                             do{if((channel <= 9) && (channel >= 0)){ADC2_SMPR2 &= (~(value << (0x7 * 3))); ADC2_SMPR2 |= (value << (channel * 3));} else{ADC2_SMPR1 &= (~(0x7 << ((channel - 10) * 3))); ADC2_SMPR1 |= (value << ((channel - 10) * 3));}}while(0)
...
#define set_ADC2_AWD_channel(channel)                                                    do{ADC2_CR1 |= 0xFFFFFFE0; ADC2_CR1 |= 0x0000001F;}while(0)
...
#define set_ADC3_AWD_channel(channel)                                                    do{ADC3_CR1 |= 0xFFFFFFE0; ADC3_CR1 |= 0x0000001F;}while(0)
