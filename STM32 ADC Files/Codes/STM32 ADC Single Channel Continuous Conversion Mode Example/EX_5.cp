#line 1 "C:/Users/Shawon & Nipa/Desktop/ADC Examples/STM32 ADC Single Channel Continuous Conversion Mode Example/EX_5.c"
#line 1 "c:/users/shawon & nipa/desktop/adc examples/stm32 adc single channel continuous conversion mode example/adc.h"
#line 1 "c:/users/shawon & nipa/desktop/adc examples/stm32 adc single channel continuous conversion mode example/gpio.h"
#line 5 "C:/Users/Shawon & Nipa/Desktop/ADC Examples/STM32 ADC Single Channel Continuous Conversion Mode Example/EX_5.c"
...
void ADC_init()
{
  ...
  do{if((2 <= 9) && (2 >= 0)){ADC1_SMPR2 &= (~(0x7 << (2 * 3))); ADC1_SMPR2 |= ( 0x04  << (2 * 3));} else{ADC1_SMPR1 &= (~(0x7 << ((2 - 10) * 3))); ADC1_SMPR1 |= ( 0x04  << ((2 - 10) * 3));}}while(0) ;
  do{if((1 >= 1) && (1 <= 6)){ADC1_SQR3 &= (~(0x1F << ((1 - 1) * 5))); ADC1_SQR3 |= (2 << ((1 - 1) * 5));}else if((1 >= 7) && (1 <= 12)){ADC1_SQR2 &= (~(0x1F << ((1 - 7) * 5))); ADC1_SQR2 |= (2 << ((1 - 7) * 5));}else{ADC1_SQR1 &= (~(0x1F << ((1 - 13) * 5))); ADC1_SQR1 |= (2 << ((1 - 13) * 5));}}while(0) ;
