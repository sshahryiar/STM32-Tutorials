...
#define set_TIM3_OC1_compare_mode(mode)                                                  do{TIM3_CCMR1_Output &= (~(0x7 << 4));  TIM3_CCMR1_Output |= (value << 4);}while(0)
#define set_TIM3_OC2_compare_mode(mode)                                                  do{TIM3_CCMR1_Output &= (~(0x7 << 12));  TIM3_CCMR1_Output |= (value << 12);}while(0)
#define set_TIM3_OC3_compare_mode(mode)                                                  do{TIM3_CCMR2_Output &= (~(0x7 << 4));  TIM3_CCMR2_Output |= (value << 4);}while(0)
#define set_TIM3_OC4_compare_mode(mode)                                                  do{TIM3_CCMR2_Output &= (~(0x7 << 12));  TIM3_CCMR2_Output |= (value << 12);}while(0)
