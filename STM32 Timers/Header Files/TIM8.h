...
#define set_TIM8_OC1_compare_mode(value)                                                 do{TIM8_CCMR1_Output &= (~(0x7 << 4));  TIM8_CCMR1_Output |= (value << 4);}while(0)
#define set_TIM8_OC2_compare_mode(value)                                                 do{TIM8_CCMR1_Output &= (~(0x7 << 12));  TIM8_CCMR1_Output |= (value << 12);}while(0)
#define set_TIM8_OC3_compare_mode(value)                                                 do{TIM8_CCMR2_Output &= (~(0x7 << 4));  TIM8_CCMR2_Output |= (value << 4);}while(0)
#define set_TIM8_OC4_compare_mode(value)                                                 do{TIM8_CCMR2_Output &= (~(0x7 << 12));  TIM8_CCMR2_Output |= (value << 12);}while(0)
